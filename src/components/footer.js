...
import { siteFooter, logo } from './footer.module.scss'
  ...
  return (
    <footer className={ siteFooter }>
      <a href="https://twitter.com/nickang" target="_blank" rel="noopener noreferrer">
        <img alt="twitter icon" src={twitterLogo} className={ logo } />
      </a>
      {/** <a href="https://www.instagram.com/nickang_blog/" target="_blank" rel="noopener noreferrer">
        <img alt="instagram icon" src={instagramLogo} className={ logo } />
      </a> */}
    </footer>
  )
}
