...
const HomePage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>I'm currently an Engineering Team Lead at <a href="https://smartly.io">Smartly.io</a>. I write about a broad range of things that I learn and observe, and they seem to coalesce around topics like technology, living a meaningful life, and communicating well.</p>
      <p>I publish new articles every Sunday. <Link to="/subscribe">Subscribe</Link> for free occasional updates. I try to be helpful with each article I publish. If something you read helped you, please <Link to="/contact">reach out</Link> and/or <a target="_blank" rel="noreferrer" href={`https://ko-fi.com/nickang`}>buy me a coffee</a>.</p>
