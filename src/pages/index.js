...
const HomePage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <p>So, that's my <a href="https://sive.rs/publicu">public persona</a> in brief. Send me a <a href="https://twitter.com/nickang">tweet</a> if you have something you want to talk about.</p>
    </Layout>
  )
}
