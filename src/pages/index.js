...
const HomePage = ({ data, location }) => {
  ...
  return (
    <Layout location={location} title={siteTitle}>
      ...
      <ul>
        <li>
          <Link to="/2017-03-12-general-assembly-singapore-review/">Generaly Assembly Singapore review</Link>
        </li>
        <li>
