...
const NowPage = ({ data, location }) => {
  ...
  return (
    ...
    <ul><li>Publishing small, self-contained concepts on <a href="https://www.instagram.com/nickang_blog/">Instagram: @nickang_blog</a></li><li>Publishing medium length blog posts that build on basic concepts on this blog</li><li>Creating a book or some other product offering, like an instructor-led online course, that is structured to help someone who is serious in becoming more technical to get to that destination as effectively and successfully as possible</li></ul>
